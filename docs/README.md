...
| [`agent/state.json`](agent/state.json) | The machine-readable sprint pointer. Generated by `scripts/sync_sprint_state.py` from the sprint files (DEC-148); validated against them by `scripts/validate_project.py`. |
