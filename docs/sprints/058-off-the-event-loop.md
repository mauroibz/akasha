# Sprint 058 — Nothing blocks the event loop **[GATED]**
...
9. **Release notes for v1.5.3.** If Phase A ends the sprint, the release is a documented measurement
...
- Anything from Sprints 056, 057 or 059.
...
5. `[DOCS] Re-measured, and release notes for v1.5.3`
6. `[DOCS] Close sprint 058 and hand off`
