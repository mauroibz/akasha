...
`AKASHA_MIN_FREE_BYTES`, `AKASHA_SQLITE_BUSY_TIMEOUT_MS`, `AKASHA_ENVIRONMENT`, `AKASHA_DATA_DIR`, `AKASHA_CALIBRE_DIR`,
...
| `AKASHA_MIN_FREE_BYTES` | `524288000` (500 MB) | Below this much free space, a write is refused before it starts rather than failing partway through |
...
| `AKASHA_VERSION`      | `1.5.6`          | Image tag compose pulls. Pin a version so an upgrade or a rollback is a variable, not a rebuild — `latest` moves under you |
